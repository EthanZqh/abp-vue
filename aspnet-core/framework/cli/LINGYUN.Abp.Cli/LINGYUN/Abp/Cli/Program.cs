    ...
    public class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .MinimumLevel.Override("ZQH.Abp", LogEventLevel.Warning)
                .MinimumLevel.Override("System.Net.Http.HttpClient", LogEventLevel.Warning)
#if DEBUG
                .MinimumLevel.Override("Volo.Abp.Cli", LogEventLevel.Debug)
                .MinimumLevel.Override("ZQH.Abp.Cli", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("Volo.Abp.Cli", LogEventLevel.Information)
                .MinimumLevel.Override("ZQH.Abp.Cli", LogEventLevel.Information)
#endif
