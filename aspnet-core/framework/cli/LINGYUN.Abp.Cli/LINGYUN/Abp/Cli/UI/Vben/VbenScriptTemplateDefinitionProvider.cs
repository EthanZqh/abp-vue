...
public class VbenScriptTemplateDefinitionProvider : TemplateDefinitionProvider
{
    ...
    private static TemplateDefinition[] CreateCliTemplates()
    {
        return new[]
        {
            ...
            ).WithVirtualFilePath("/ZQH.Abp/Cli/UI/Vben/Templates/VbenModelDataScript.tpl", true),
            new TemplateDefinition(
                "VbenModalView",
                typeof(DefaultResource),
                L("Templates:VbenModalView")
            ).WithVirtualFilePath("/ZQH.Abp/Cli/UI/Vben/Templates/VbenModalViewScript.tpl", true),
            new TemplateDefinition(
                "VbenTableData",
                typeof(DefaultResource),
                L("Templates:VbenTableData")
            ).WithVirtualFilePath("/ZQH.Abp/Cli/UI/Vben/Templates/VbenTableDataScript.tpl", true),
            new TemplateDefinition(
                "VbenTableView",
                typeof(DefaultResource),
                L("Templates:VbenTableView")
            ).WithVirtualFilePath("/ZQH.Abp/Cli/UI/Vben/Templates/VbenTableViewScript.tpl", true),
            new TemplateDefinition(
                "VbenComponentIndex",
                typeof(DefaultResource),
                L("Templates:VbenComponentIndex")
            ).WithVirtualFilePath("/ZQH.Abp/Cli/UI/Vben/Templates/VbenComponentIndexScript.tpl", true),
        };
    }
