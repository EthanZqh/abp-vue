using ZQH.Abp.Features.LimitValidation.Localization;
...
namespace ZQH.Abp.Features.LimitValidation;
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/ZQH.Abp/Features/LimitValidation/Localization/Resources");
        });
    }
}
