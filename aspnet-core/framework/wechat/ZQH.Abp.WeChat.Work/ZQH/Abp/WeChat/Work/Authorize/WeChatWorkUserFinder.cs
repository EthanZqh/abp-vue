using ZQH.Abp.WeChat.Work.Authorize.Models;
using ZQH.Abp.WeChat.Work.Authorize.Request;
using ZQH.Abp.WeChat.Work.Authorize.Response;
using ZQH.Abp.WeChat.Work.Features;
using ZQH.Abp.WeChat.Work.Token;
...
namespace ZQH.Abp.WeChat.Work.Authorize;
