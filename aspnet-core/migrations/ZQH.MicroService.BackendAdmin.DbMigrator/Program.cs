...
#if DEBUG
                .MinimumLevel.Override("ZQH.MicroService.BackendAdmin.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("ZQH.MicroService.BackendAdmin.DbMigrator", LogEventLevel.Information)
#endif
