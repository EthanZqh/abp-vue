...
public class OnboardingDbMigrationService : EfCoreRuntimeDbMigratorBase<OnboardingMigrationsDbContext>, ITransientDependency
{
    protected IDataSeeder DataSeeder { get; }
    protected IDbSchemaMigrator DbSchemaMigrator { get; }
    protected ITenantRepository TenantRepository { get; }

    public OnboardingDbMigrationService(
