...
#if DEBUG
                .MinimumLevel.Override("ZQH.MicroService.RealtimeMessage.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("ZQH.MicroService.RealtimeMessage.DbMigrator", LogEventLevel.Information)
#endif
