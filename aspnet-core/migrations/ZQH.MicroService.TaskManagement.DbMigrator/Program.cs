...
#if DEBUG
                .MinimumLevel.Override("ZQH.MicroService.TaskManagement.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("ZQH.MicroService.TaskManagement.DbMigrator", LogEventLevel.Information)
#endif
