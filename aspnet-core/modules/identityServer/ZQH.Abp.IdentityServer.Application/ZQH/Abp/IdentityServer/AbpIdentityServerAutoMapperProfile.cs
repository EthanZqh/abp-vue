using AutoMapper;
using ZQH.Abp.IdentityServer.ApiResources;
using ZQH.Abp.IdentityServer.ApiScopes;
using ZQH.Abp.IdentityServer.Clients;
using ZQH.Abp.IdentityServer.Grants;
using ZQH.Abp.IdentityServer.IdentityResources;
