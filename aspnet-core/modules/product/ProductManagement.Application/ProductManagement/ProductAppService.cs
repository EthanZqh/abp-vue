...
namespace ProductManagement
{
    ...
    public class ProductAppService : ApplicationService, IProductAppService
    {
        ...
        //}
        public ProductAppService(ProductManager productManager, IRepository<Product, Guid> productRepository, IProductRepository productRepository1)
        {
            _productManager = productManager;
            _productRepository = productRepository;
        ...
        public async Task<PagedResultDto<ProductDto>> GetListPaged1Async(ProductGetByPagedInputDto input)
        {
            //await NormalizeMaxResultCountAsync(input);
            ...
            var count = await ProductRepository.GetCountAsync(input.Filter);
