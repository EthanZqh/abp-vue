...
{
    [RemoteService(Name = ProductManagementHttpApiClientModule.RemoteServiceName)]
    ...
    public class ProductsController : AbpController, IProductAppService
    {
       ...
       // public Task<PagedResultDto<ProductDto>> GetListPagedAsync(ProductGetByPagedInputDto input)
        {
            return _productAppService.GetListPagedAsync(input);
        }
        [HttpGet]
        [Route("pages")]
        public Task<PagedResultDto<ProductDto>> GetListPaged1Async(ProductGetByPagedInputDto input)
        {
            return _productAppService.GetListPaged1Async(input);
        }
