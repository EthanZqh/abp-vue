...
using ZQH.MicroService.AuthServer.Authentication;
...
public partial class AuthServerModule
{
    ...
    private void PreConfigureAuth()
    {
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                //options.AddAudiences("zqh-abp-application");
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<AuthServerModule>("ZQH.MicroService.AuthServer");
        });
    }
