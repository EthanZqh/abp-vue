...
public class ServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    public async Task SeedAsync(DataSeedContext context)
    {
        ...
        if (await _scopeManager.FindByNameAsync("zqh-abp-application") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor()
            {
                Name = "zqh-abp-application",
                DisplayName = "zqh-abp-application",
                DisplayNames =
                {
        ...
        if (await _applicationManager.FindByClientIdAsync("vue-admin-client") == null)
        {
            await _applicationManager.CreateAsync(new OpenIddictApplicationDescriptor
            {
                ...
                Permissions =
                {
                    ...
                    OpenIddictConstants.Permissions.Prefixes.Scope + "zqh-abp-application"
                }
            });
        }
