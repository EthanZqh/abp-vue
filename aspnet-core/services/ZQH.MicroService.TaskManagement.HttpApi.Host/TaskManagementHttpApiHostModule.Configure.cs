...
public partial class TaskManagementHttpApiHostModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<TaskManagementHttpApiHostModule>("ZQH.Abp.TaskManagement");

            //options.FileSets.AddEmbedded<TaskManagementHttpApiHostModule>("ZQH.MicroService.TaskManagement");
        });
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            ...
            ////options.UsePersistence<TestResource>();
            //options.UsePersistence<DemoResource>();
