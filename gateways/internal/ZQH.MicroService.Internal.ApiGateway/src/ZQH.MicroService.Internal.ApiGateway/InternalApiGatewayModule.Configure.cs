...
using ZQH.MicroService.Internal.ApiGateway.Localization;
...
namespace ZQH.MicroService.Internal.ApiGateway
{
    public partial class InternalApiGatewayModule
    {
        ...
        private void ConfigureVirtualFileSystem()
        {
            ...
            {
                options.FileSets.AddEmbedded<InternalApiGatewayModule>("ZQH.MicroService.Internal.ApiGateway");
            });
        }
        ...
        private void ConfigureCaching(IConfiguration configuration)
        {
            Configure<AbpDistributedCacheOptions>(options =>
            {
                ...
                options.KeyPrefix = "ZQH.Abp.Application";
                // 滑动过期30天
